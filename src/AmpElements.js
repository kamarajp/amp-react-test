...
<!doctype html>
    ...
    <head>
        ...
        <scr` +
    `ipt async src='https://cdn.ampproject.org/v0.js'></scr` +
    `ipt>
        <scr` +
    `ipt async custom-element='amp-video'
            src='https://cdn.ampproject.org/v0/amp-video-0.1.js'></scr` +
    `ipt>
        <scr` +
    `ipt async custom-element='amp-story'
            src='https://cdn.ampproject.org/v0/amp-story-1.0.js'></scr` +
    `ipt>
...
export { ampStoriesHead, ampStoriesEnd };
